...
![Transformer architecture: encoder (e.g. input "I heard a dog bark") and decoder (e.g. prompt "when my dog was a ..." predicting the next token "puppy")](../assets/generative-ai-llm-transformer-architecture.png)
...
![Word embeddings as vectors in space: similar meanings (e.g. dog and puppy) point in similar directions](../assets/generative-ai-llm-embeddings-vector-space.png)
