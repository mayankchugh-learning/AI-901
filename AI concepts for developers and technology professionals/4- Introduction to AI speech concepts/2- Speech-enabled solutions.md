...
![Speech recognition (speech-to-text): spoken audio is processed into written text](../assets/Speech1.png)
...
![Speech synthesis (text-to-speech): written text is processed into spoken audio](../assets/Speech2.png)
