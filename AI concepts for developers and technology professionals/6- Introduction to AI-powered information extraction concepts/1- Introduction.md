...
![Diagram of a business card with extracted fields (company name, contact name, title, email, and phone highlighted).](../assets/information-extraction-business-card-extracted-fields.png)
