...
![Diagram of token vectors in semantic space: related words point in similar directions.](../assets/cv-modern-vision-language-token-vectors.png)
...
![Diagram of a photo divided into a grid of patches, each mapped to an embedding vector.](../assets/cv-modern-vision-patch-embedding.png)
...
![Diagram of vision embeddings: visual concepts represented as vectors from a common origin.](../assets/cv-modern-vision-visual-embeddings.png)
...
![Diagram of a multimodal model: language labels and visual icons mapped into a shared embedding space.](../assets/cv-modern-vision-multimodal-shared-space.png)
...
![Photograph of a person in a park with a hat and a backpack.](../assets/cv-modern-vision-caption-example.png)
