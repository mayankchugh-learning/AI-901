...
![CNN for image classification: input fruit images, convolutional filters and feature maps, flattening, fully connected layers, and class outputs (apple, banana, orange).](../assets/cv-cnn-image-classification-pipeline.png)
