...
> **Tip**  
> For more information about generative AI models in Microsoft Foundry, see [Azure AI Foundry models](https://azure.microsoft.com/products/ai-foundry/models/).  
> For more information about creating agents with Microsoft Foundry, see [Azure AI Foundry Agent Service](https://azure.microsoft.com/products/ai-foundry/agent-service/).
