...
To create an agent in Foundry, you can start by exploring a model or go straight to agent development. In Foundry portal, creating an agent looks similar at first to testing a model in the playground.

1. Choose the model your agent uses.
2. Write system instructions, such as: "You're a helpful scheduling assistant who returns answers in concise bullet points."

What sets the agent apart from using the model alone is the addition of tools and knowledge:
...
- Take real actions (read or write files, search, update systems)
- Execute workflows
...
![Screenshot of the Foundry portal with the dialog box open to save, name, and create your agent.](asset/4- Creating an agent-1-create-agent-dialog.png)

![Screenshot of the Foundry portal with the agent saved and open in the playground.](asset/4- Creating an agent-2-agent-playground-saved.png)
...
![Screenshot of the agent ID that can be found with the environment variables.](asset/4- Creating an agent-3-env-variables-agent-id.png)
...
![Screenshot of publishing an agent in the Foundry portal.](asset/4- Creating an agent-4-publish-confirmation.png)

![Screenshot of an agent after it is published in the Foundry portal with endpoint information.](asset/4- Creating an agent-5-agent-published-endpoints.png)
