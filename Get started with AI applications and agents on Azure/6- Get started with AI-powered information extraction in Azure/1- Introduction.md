...
*Training PDF (browser export):* [1- Introduction - Training _ Microsoft Learn.pdf](./1- Introduction - Training _ Microsoft Learn.pdf)
...
*Next unit: [Extract information from documents](https://learn.microsoft.com/en-us/training/modules/get-started-information-extraction/2-extract-data-documents)*