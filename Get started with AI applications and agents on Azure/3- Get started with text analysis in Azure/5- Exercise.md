...
*Training PDF (browser export):* [5- Get started with text analysis in Microsoft Foundry _ Get started with AI apps and agents in Azure.pdf](./5- Get started with text analysis in Microsoft Foundry _ Get started with AI apps and agents in Azure.pdf)
...
![Foundry project home: welcome, project API key, and endpoints.](asset/5- Exercise-01-foundry-project-home.png)
...
![Discover > Models: model catalog.](asset/5- Exercise-02-model-catalog.png)

2. Search for and select the **gpt-4.1** model, and view the page for this model, which describes its features and capabilities.

![Search results for gpt-4.1 in the model catalog.](asset/5- Exercise-03-model-catalog-search-gpt-4-1.png)
...
![gpt-4.1 model details: Deploy > Default settings.](asset/5- Exercise-04-deploy-gpt-4-1-default-settings.png)
...
![Playground: sentiment analysis of a positive hotel review.](asset/5- Exercise-05-playground-sentiment.png)
...
![Playground: named entity recognition for cities and the event name.](asset/5- Exercise-06-playground-named-entities.png)
...
![Playground: one-paragraph summary of a meeting transcript.](asset/5- Exercise-07-playground-summarize.png)
...
![Build > Models > AI Services: Azure Language and other AI services.](asset/5- Exercise-08-models-ai-services-language.png)
...
![Language detection playground: confidence and ISO code for detected language.](asset/5- Exercise-09-language-detection-playground.png)
...
> **Tip:** You can use [Bing Translator](https://www.bing.com/translator) to generate text in languages you don’t speak!
...
![Text PII playground: redacted text and entity details on the Response tab.](asset/5- Exercise-10-pii-playground-response.png)
...
4. Experiment with input of your own. Azure Language can recognize an extensive list of PII. You can see the [full list in the Azure AI Language documentation](https://learn.microsoft.com/en-us/azure/ai-services/language-service/personally-identifiable-information/overview). A few of those entities include:
...
![Text PII playground: Code tab with Python sample using TextAnalyticsClient.](asset/5- Exercise-11-pii-playground-code-tab.png)
...
- [Personally identifiable information (PII) in Azure AI Language](https://learn.microsoft.com/en-us/azure/ai-services/language-service/personally-identifiable-information/overview)
