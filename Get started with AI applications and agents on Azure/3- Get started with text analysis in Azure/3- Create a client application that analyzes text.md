...
*Training PDF (browser export):* [3- Create a client application that analyzes text - Training _ Microsoft Learn.pdf](./3- Create a client application that analyzes text - Training _ Microsoft Learn.pdf)
...
*Next unit: [Use Azure Language with an agent](https://learn.microsoft.com/en-us/training/modules/get-started-text-analysis-azure/4-language-mcp)*
