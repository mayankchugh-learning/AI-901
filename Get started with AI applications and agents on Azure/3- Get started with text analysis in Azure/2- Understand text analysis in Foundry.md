...
*Training PDF (browser export):* [2- Understand text analysis in Foundry - Training _ Microsoft Learn.pdf](./2- Understand text analysis in Foundry - Training _ Microsoft Learn.pdf)
...
![Foundry playground (gpt-4.1-mini): sample unstructured text with extracted key phrases listed in the chat response.](./asset/2- Understand text analysis in Foundry-1-playground-key-phrases.png)
...
![Build > Models > AI Services: pre-built Azure services including Azure Language (language detection, text PII redaction), Translator, Speech, and Content Understanding.](./asset/2- Understand text analysis in Foundry-2-ai-services-tab.png)
...
| Language | ISO 639-1 code | Confidence score |
| --- | --- | --- |
| Spanish | es | 1.00 |

In the Foundry portal, you can test Azure Language's language detection feature in the chat Playground.

![Azure Language — Language detection playground: Spanish input text with detected language, ISO code, script, and confidence.](./asset/2- Understand text analysis in Foundry-3-language-detection-playground.png)
...
![Azure Language — Text PII redaction playground: redacted text with placeholders and entity details (type, confidence, offsets).](./asset/2- Understand text analysis in Foundry-4-pii-redaction-playground.png)
...
*Next unit: [Create a client application that analyzes text](https://learn.microsoft.com/en-us/training/modules/get-started-text-analysis-azure/3-language-sdk)*
