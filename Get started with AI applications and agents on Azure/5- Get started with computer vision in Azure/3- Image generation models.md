...
![Image generation in the Foundry playground](images/3-foundry-image-generation-playground.png)

![Code example in the Foundry playground](images/3-foundry-image-generation-code.png)
...
> **Note**
> Base64 refers to files like images that are binary (raw bytes). JSON and URLs are text-only. Base64 encoding converts binary data into safe ASCII text and allows binary files to be embedded inside JSON or URLs.
...
**Next unit:** Video generation models