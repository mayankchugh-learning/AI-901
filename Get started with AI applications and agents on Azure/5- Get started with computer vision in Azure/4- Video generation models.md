...
*Training PDF (browser export):* [4- Video generation models - Training _ Microsoft Learn.pdf](./4- Video generation models - Training _ Microsoft Learn.pdf)
...
![Foundry model catalog filtered to video generation models (including Sora).](./images/4-foundry-video-model-catalog.png)
...
![Sora in the Foundry playground with prompt, aspect ratio, and video settings.](./images/4-foundry-video-playground-sora.png)
...
![Foundry playground sample code dialog for a Sora video generation request.](./images/4-foundry-video-playground-sample-code.png)
...
*Next unit: Exercise - Get started with computer vision in Microsoft Foundry*