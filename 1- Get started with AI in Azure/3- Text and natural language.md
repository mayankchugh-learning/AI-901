...
- **Text classification** — assigning a document to a specific category; including **sentiment analysis** to determine whether a body of text is positive, negative, or neutral.
...
- Implementing chatbots that can answer frequently asked questions or orchestrate predictable conversational dialogs that do not require the complexity of generative AI.
