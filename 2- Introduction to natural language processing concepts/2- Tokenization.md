...
![Module page: Tokenization with content format options (Video or Text and images)](../assets/nlp-tokenization-module.png)
...
![Expandable techniques table: Technique and Description columns](../assets/nlp-tokenization-techniques-table.png)
